...
The difference is that SQL is not a database but rather a database management system.

- [x] Why do tables need a `primary key`?

Because primary keys allow us to identify each entry in the database uniquely.
